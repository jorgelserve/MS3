...
void loop() {
  ...
  int voltajeBateria1 = 5.0 * volBat1 / 1024 * 100;
  //Serial.print("VoltBat: ");Serial.print(voltajeBateria1);
  ...
  //Serial.print("TempR: ");Serial.print(tempRad);load_volt(voltajeBateria1);
