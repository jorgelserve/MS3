...
// - Home:       0
// - IGate:      5
#define S_CALLSIGN      "HJ4GAL"
#define S_CALLSIGN_ID   11

// Destination callsign: APRS (with SSID=0) is usually okay.
#define D_CALLSIGN      "APZ"
...
// it is to noise. 
#define APRS_COMMENT    "MS3"   //Simple vital por Simple Space (S^2)
...
// --------------------------------------------------------------------------
// Tracker config (trackuino.pde) (Ya no esta presente) SimpleVital
// --------------------------------------------------------------------------
...
// of the CPU activity.
#define LED_PIN                 10 //(usado para inidicar que el radio esta durmiendo, off-dormido)
