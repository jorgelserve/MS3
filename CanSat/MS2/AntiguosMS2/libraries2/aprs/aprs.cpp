...
// Variables GPS
char gps_time[] = "170915";
char gps_aprs_lat[] = "000000";
char gps_aprs_lon[] = "000000"; 
float gps_course = 0; 
float gps_speed = 0; 
...
void aprs_send() {
  ...
  snprintf(temp, 7, "%05d", (int)(gps_altitude + 0.5));
  ax25_send_string(temp);
  ax25_send_string("/T=");
  ...
  ax25_send_string(temp);
  ax25_send_string("/V=");
  snprintf(temp, 6, "%d", (int)(voltajeBateria1 * 100));
  ax25_send_string(temp);
  ax25_send_byte(' ');
